...
QT_MOC_LITERAL(4, 31, 9), // "TrackTags"
QT_MOC_LITERAL(5, 41, 4), // "tags"
QT_MOC_LITERAL(6, 46, 13), // "onSaveClicked"
QT_MOC_LITERAL(7, 60, 19), // "onFetchCoverClicked"
QT_MOC_LITERAL(8, 80, 20), // "onFetchLyricsClicked"
QT_MOC_LITERAL(9, 101, 14) // "onCoverClicked"

    },
    "EditorPanel\0saveTags\0\0filepath\0TrackTags\0"
    "tags\0onSaveClicked\0onFetchCoverClicked\0"
    "onFetchLyricsClicked\0onCoverClicked"
};
...
void EditorPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->saveTags((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const TrackTags(*)>(_a[2]))); break;
        case 1: _t->onSaveClicked(); break;
        case 2: _t->onFetchCoverClicked(); break;
        case 3: _t->onFetchLyricsClicked(); break;
        case 4: _t->onCoverClicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (EditorPanel::*)(const QString & , const TrackTags & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EditorPanel::saveTags)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject EditorPanel::staticMetaObject = { {
    ...
    qt_meta_stringdata_EditorPanel.data,
    qt_meta_data_EditorPanel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void EditorPanel::saveTags(const QString & _t1, const TrackTags & _t2)
{
